...
import PcDark from '../../public/images/profile/pc-dark.jpg';
import PcLight from '../../public/images/profile/pc.jpg';
const timelineStyles = makeStyles(theme => ({
  root: {
    position: 'relative',
    
    [theme.breakpoints.up('sm')]: {
      background: `url(${theme.palette.type === 'dark' ? PcDark : PcLight}) no-repeat bottom right`,
    },
